...
import type { CreateAnalysisBodyDTO } from '~~/server/api/schemas/analyses/create-analysis.body.schema'
import type { GetAnalysesQueryDTO } from '~~/server/api/schemas/analyses/get-analyses.query.schema'
import type { GetAnalysesResponseDTO, AnalysisItemDTO } from '~~/server/api/schemas/analyses/get-analyses.response.schema'
